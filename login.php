...
<div class='form-group'>
		...
		Password:
	      ...
	      <input class='col-sm-5 col-md-3' type='password' name='password' id='password' placeholder='Password' class='create' required='required'/>
	      </div>
<div class='form-group'>
	      <label class='col-sm-3 col-md-2' for='password2'>
		Confirm Password:
	      </label>
	      <input class='col-sm-5 col-md-3' type='password' name='password2' id='password2' class='create' placeholder='Confirm password' required='required'/>
	      </div>
<div class='form-group'>
