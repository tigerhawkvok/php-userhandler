...
<div class='form-group'>
		...
		Password:
	      ...
	      <input class='col-sm-5 col-md-3 password-input' type='password' name='password' id='password' placeholder='Password' required='required'/> <span class='glyphicon glyphicon-question-sign do-password-reset' id='reset-password-icon' data-toggle='tooltip' title='Forgot Password?'></span>
</div>
</fieldset>";
$loginform_close="	      <br/>
